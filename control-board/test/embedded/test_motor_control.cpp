...
PID left_pid(-300, 300, 1.0, 1.0, 1.0);
PID right_pid(-300, 300, 1.0, 1.0, 1.0);
...
void testForwardMotion() {
    ...
    Kinematics::rpm req_rpm = kinematics.rpmForMotion(0.5, 0);
    ...
    TEST_ASSERT_FLOAT_WITHIN(0.1, 0, left_error);
    TEST_ASSERT_FLOAT_WITHIN(0.1, 0, right_error);
}
